...
class AddSecurityHeaders
{
    ...
    private function contentSecurityPolicy(): string
    {
        ...
        return implode('; ', [
            ...
            "connect-src 'self' https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:* wss: {$connectExtra}",

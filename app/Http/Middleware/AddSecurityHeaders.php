...
class AddSecurityHeaders
{
    ...
    private function contentSecurityPolicy(): string
    {
        ...
        return implode('; ', [
            ...
            "object-src 'none'",
            "script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://unpkg.com https://static.cloudflareinsights.com http://localhost:* http://127.0.0.1:*",
            "script-src-elem 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://unpkg.com https://static.cloudflareinsights.com http://localhost:* http://127.0.0.1:*",
